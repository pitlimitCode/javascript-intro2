...
console.log(fruits2.includes("Mango")); // true
...
const xArray4 = [1, 2, 3, 4, 5]
xArray4.unshift(8);
console.log(xArray4); // [ 8, 1, 2, 3, 4, 5 ]
xArray4.push(9);
console.log(xArray4); // [ 8, 1, 2, 3, 4, 5, 9 ]
...
const fruits7 = ["Apple", "Banana", "Guava"];
console.log(fruits7.splice(1, 2, "Cherry", "Durian" )); // [ 'Banana', 'Guava' ]
console.log(fruits7); // [ 'Apple', 'Cherry', 'Durian' ]

// 8. .slice(), melihat urutan array yang dipilih. Tidak merubah isi array.
let fruits8 = ["Apple", "Banana", "Cherry", "Durian", "Guava"];
console.log(fruits8.slice(0, 5));   // [ 'Apple', 'Banana', 'Cherry', 'Durian', 'Guava' ]
console.log(fruits8.slice(1, 5));   // [ 'Apple', 'Banana', 'Cherry', 'Durian', 'Guava' ]
console.log(fruits8.slice(0, 4));   // [ 'Apple', 'Banana', 'Cherry', 'Durian' ]
console.log(fruits8.slice(-5, -1)); // [ 'Apple', 'Banana', 'Cherry', 'Durian' ]
console.log(fruits8.slice(-5, 0));  // [ ]
console.log(fruits8.slice(-5, 5));  // [ 'Apple', 'Banana', 'Cherry', 'Durian', 'Guava' ]
console.log(fruits8.slice(1, -1));  // [ 'Banana', 'Cherry', 'Durian' ]
console.log(fruits8.slice(1, 0));   // [ ]
...
console.log(fruits9.sort());   // [ 'Apple', 'Banana', 'Mango', 'Orange' ]
console.log(fruits9.reverse());// [ 'Orange', 'Mango', 'Banana', 'Apple' ]
// Jika dari item number, .sort() perlu bantuan function
const numbers9 = [45, 4, 9, 16, 25];
console.log(numbers9.sort((a, b) => {return a - b})); // [ 4, 9, 16, 25, 45 ]
console.log(numbers9.sort(function(a, b){return b - a})); // [ 45, 25, 16, 9, 4 ]
console.log(numbers9.sort(function(a, b){return 0.5 - Math.random()})); // random
